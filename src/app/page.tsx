          ...
          >
            ...
            <div className="relative z-10 flex items-center justify-between h-12">
              ...
              <div className="hidden md:flex items-center gap-2">
                <a 
                  href="https://github.com/optimizerplus/optimizer-plus" 
                  target="_blank"
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="opt-glass-panel rounded-3xl p-8 sm:p-12 animate-border-glow relative overflow-hidden card-3d crt-effect">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a 
              href="https://github.com/optimizerplus/optimizer-plus/releases/download/v4.0.0/Boosteroid.Optimizer.Plus.by.Derfog-4.0.0.user.js" 
